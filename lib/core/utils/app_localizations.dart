...
class AppLocalizations {
  ...
  static const _copy = {
    'en': {
      ...
      'errorPaymentRequired': 'You have reached your plan limit. Please upgrade to continue.',
      'loadingCreatingStudy': 'Creating your study…',
      'loadingUploadingFiles': 'Uploading your files…',
      'loadingProcessingContent': 'Processing content…',
      'loadingAlmostReady': 'Almost ready, generating questions…',
      'retry': 'Retry',
      'loading': 'Loading…',
      'question': 'Question',
      'next': 'Next',
      ...
      'planUnavailable': 'This selection is not available yet.',
      'playfulBody':
      ...
      'totalPagesLabel': 'Total pages in document: {count}',
      'totalPagesUnknown': 'Total page count unavailable for this file type',
      'totalLinesLabel': 'Total lines in file: {count}',
      'totalLinesUnknown': 'Total line count unavailable for this file',
      ...
      'storageAvailableTooltip': '{available} MB available of {total} MB',
      ...
      'studiesActivityLabel': 'Studies created, last 14 days',
      ...
      'noSupportTicketsYet': 'You have no support tickets yet.',
      'ticketStatusOpen': 'Open',
      'ticketStatusPending': 'Pending',
      'ticketStatusResolved': 'Resolved',
      'ticketStatusClosed': 'Closed',
      'ticketSubjectLabel': 'Subject (optional)',
      'ticketBodyLabel': 'How can we help?',
      'supportTicketTitle': 'Support ticket',
      'ticketThreadUnavailable':
          'Messages are temporarily unavailable, but your ticket is safe and will show its full history again shortly.',
      'supportTeamLabel': 'Support team',
      'youLabel': 'You',
      'attachmentLabel': 'Attachment',
      'attachImageAction': 'Attach image',
      'ticketReplyHint': 'Write a reply…',
    },
    'pt': {
      'appName': 'Certifications',
      'ok': 'OK',
      ...
      'errorPaymentRequired': 'Você atingiu o limite do seu plano. Faça upgrade para continuar.',
      'loadingCreatingStudy': 'Criando seu estudo…',
      'loadingUploadingFiles': 'Enviando seus arquivos…',
      'loadingProcessingContent': 'Processando conteúdo…',
      'loadingAlmostReady': 'Quase pronto, gerando perguntas…',
      ...
      'totalPagesLabel': 'Total de páginas no documento: {count}',
      'totalPagesUnknown': 'Total de páginas indisponível para este tipo de arquivo',
      'totalLinesLabel': 'Total de linhas no arquivo: {count}',
      'totalLinesUnknown': 'Total de linhas indisponível para este arquivo',
      'sourcesLabel': 'Fontes',
      ...
      'storageUsedLabel': 'Espaço Usado',
      'storageAvailableTooltip': '{available} MB disponíveis de {total} MB',
      ...
      'studiesActivityLabel': 'Estudos criados, últimos 14 dias',
      'deleteStudyConfirm':
      ...
      'noSupportTicketsYet': 'Você ainda não tem nenhum chamado de suporte.',
      'ticketStatusOpen': 'Aberto',
      'ticketStatusPending': 'Pendente',
      'ticketStatusResolved': 'Resolvido',
      'ticketStatusClosed': 'Fechado',
      'ticketSubjectLabel': 'Assunto (opcional)',
      'ticketBodyLabel': 'Como podemos ajudar?',
      'supportTicketTitle': 'Chamado de suporte',
      'ticketThreadUnavailable':
          'As mensagens estão temporariamente indisponíveis, mas seu chamado está seguro e o histórico completo volta a aparecer em breve.',
      'supportTeamLabel': 'Equipe de suporte',
      'youLabel': 'Você',
      'attachmentLabel': 'Anexo',
      'attachImageAction': 'Anexar imagem',
      'ticketReplyHint': 'Escreva uma resposta…',
    },
    'th': {
      'appName': 'Certifications',
      'ok': 'ตกลง',
      ...
      'errorPaymentRequired': 'คุณถึงขีดจำกัดของแผนแล้ว กรุณาอัปเกรดเพื่อดำเนินการต่อ',
      'loadingCreatingStudy': 'กำลังสร้างการศึกษาของคุณ…',
      'loadingUploadingFiles': 'กำลังอัปโหลดไฟล์…',
      'loadingProcessingContent': 'กำลังประมวลผลเนื้อหา…',
      'loadingAlmostReady': 'เกือบพร้อมแล้ว กำลังสร้างคำถาม…',
      'retry': 'ลองอีกครั้ง',
      'loading': 'กำลังโหลด…',
      'question': 'คำถาม',
      'next': 'ถัดไป',
      ...
      'step1ShortLabel': 'หัวข้อ',
      'step2Title': '2. เลือกแหล่งข้อมูล',
      'step2ShortLabel': 'แหล่งข้อมูล',
      'step3Title': '3. รูปแบบและความยาก',
      'step3ShortLabel': 'รูปแบบ',
      'step4Title': '4. ตรวจสอบและสร้าง',
      'step4ShortLabel': 'ตรวจสอบ',
      ...
      'totalPagesLabel': 'จำนวนหน้าทั้งหมดในเอกสาร: {count}',
      'totalPagesUnknown': 'ไม่สามารถระบุจำนวนหน้าทั้งหมดสำหรับไฟล์ประเภทนี้',
      'totalLinesLabel': 'จำนวนบรรทัดทั้งหมดในไฟล์: {count}',
      'totalLinesUnknown': 'ไม่สามารถระบุจำนวนบรรทัดทั้งหมดสำหรับไฟล์นี้',
      ...
      'storageUsedLabel': 'พื้นที่จัดเก็บที่ใช้',
      'storageAvailableTooltip': 'ว่าง {available} MB จากทั้งหมด {total} MB',
      ...
      'studiesActivityLabel': 'การเรียนที่สร้าง ใน 14 วันที่ผ่านมา',
      ...
      'newTicket': 'ตั๋วใหม่',
      'noSupportTicketsYet': 'คุณยังไม่มีตั๋วสนับสนุน',
      'ticketStatusOpen': 'เปิดอยู่',
      'ticketStatusPending': 'รอดำเนินการ',
      'ticketStatusResolved': 'แก้ไขแล้ว',
      'ticketStatusClosed': 'ปิดแล้ว',
      'ticketSubjectLabel': 'หัวข้อ (ไม่บังคับ)',
      'ticketBodyLabel': 'เราจะช่วยอะไรคุณได้บ้าง?',
      'supportTicketTitle': 'ตั๋วสนับสนุน',
      'ticketThreadUnavailable':
          'ข้อความไม่พร้อมใช้งานชั่วคราว แต่ตั๋วของคุณปลอดภัย และประวัติทั้งหมดจะกลับมาแสดงอีกครั้งในไม่ช้า',
      'supportTeamLabel': 'ทีมสนับสนุน',
      'youLabel': 'คุณ',
      'attachmentLabel': 'ไฟล์แนบ',
      'attachImageAction': 'แนบรูปภาพ',
      'ticketReplyHint': 'เขียนคำตอบ…',
    },
  };
